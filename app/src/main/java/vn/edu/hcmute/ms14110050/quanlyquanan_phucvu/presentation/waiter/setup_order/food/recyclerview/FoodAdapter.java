package vn.edu.hcmute.ms14110050.quanlyquanan_phucvu.presentation.waiter.setup_order.food.recyclerview;
...
import vn.edu.hcmute.ms14110050.quanlyquanan_phucvu.presentation.waiter.setup_order.food.recyclerview.viewholder.FoodVH;
...
public class FoodAdapter extends BaseAdapter<FoodVH,Food>{
    ...
    public FoodVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_DATA) {
            ...
            WaiterItemRecyclerFoodBinding binding =
                    DataBindingUtil.inflate(inflater, R.layout.waiter_item_recycler_food, parent, false);
