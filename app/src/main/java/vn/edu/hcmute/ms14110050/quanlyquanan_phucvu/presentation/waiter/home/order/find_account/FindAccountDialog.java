...
public class FindAccountDialog
        extends BaseNetworkDialogFragment<WaiterLayoutFindAccountBinding, FindAccountView, FindAccountViewModel>
    ...
    @Override
    protected WaiterLayoutFindAccountBinding initBinding(LayoutInflater inflater, ViewGroup container) {
        return DataBindingUtil.inflate(inflater, R.layout.waiter_layout_find_account, container, false);
    }
