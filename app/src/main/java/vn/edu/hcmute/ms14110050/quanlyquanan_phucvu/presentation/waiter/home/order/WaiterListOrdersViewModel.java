...
public class WaiterListOrdersViewModel extends BaseNetworkViewModel<WaiterListOrdersContract.View>
    ...
    private WaiterOrdersConstributor orderConstributor;


    /**
     * Constructor
     */
    public WaiterListOrdersViewModel() {
        createOrderConstributor();
        socketListener = new WaiterListOrdersSocketListener();
    ...
    private void createOrderConstributor() {
        if (orderConstributor == null) {
            orderConstributor = new WaiterOrdersConstributor();
        }
    }
    ...
    * */
    ...
    public WaiterOrdersConstributor getOrderConstributor() {
    ...
    * */
    ...
    @Override
    public void onViewAttach(@NonNull WaiterListOrdersContract.View viewCallback) {
        super.onViewAttach(viewCallback);
        socketListener.startListening();
        loadOrders();
        callback = new WaiterOnSubmitDelegacyUserName(this);
    }
    ...
    * */
    ...
    private WaiterOnSubmitDelegacyUserName callback;

    public WaiterOnSubmitDelegacyUserName getOnSubmitDelegacyUserNameCallback() {
        return callback;
    }
